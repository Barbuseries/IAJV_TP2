...
void GameWorld::HandleMenuItems(WPARAM wParam, HWND hwnd)
{
	...
	case ID_LEADERCONTROL_ENABLEPLAYERCONTROL:
	{
		m_enableMindControl = !m_enableMindControl;
		CheckMenuItemAppropriately(hwnd, ID_LEADERCONTROL_ENABLEPLAYERCONTROL, m_enableMindControl);
		m_Vehicles[0]->MindControlToggle();
	}
